...
case class RemovedContentResponse(status: String, userTier: String, total: Int, startIndex: Int, pageSize: Int, currentPage: Int, pages: Int, orderBy: String, results: List[String]) extends TStruct

object RemovedContentResponse extends TStructCodec[RemovedContentResponse] {
  val w1 = Witness(1)
  ...
  implicit val r9 = new TFieldCodec[w9.T, List[String]]()
  ...
  } yield RemovedContentResponse(status, userTier, total, startIndex, pageSize, currentPage, pages, orderBy, results)
}