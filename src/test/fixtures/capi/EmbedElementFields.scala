...
case class EmbedElementFields(html: Option[String] = None, safeEmbedCode: Option[Boolean] = None, alt: Option[String] = None, isMandatory: Option[Boolean] = None) extends TStruct
...
object EmbedElementFields extends TStructCodec[EmbedElementFields] {
  ...
  override def encode = (x) ⇒ HMap[TFieldCodec](w1.value -> x.html, w2.value -> x.safeEmbedCode, w3.value -> x.alt, w4.value -> x.isMandatory)
  ...
  } yield EmbedElementFields(html, safeEmbedCode, alt, isMandatory)
}