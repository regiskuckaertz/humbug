...
case class InteractiveElementFields(url: Option[String]= None,originalUrl: Option[String]= None,source: Option[String]= None,caption: Option[String]= None,alt: Option[String]= None,scriptUrl: Option[String]= None,html: Option[String]= None,scriptName: Option[String]= None,iframeUrl: Option[String]= None,role: Option[String]= None,isMandatory: Option[Boolean]= None) extends TStruct
...
override def encode = (x) => HMap[TFieldCodec](w1.value -> x.url,w2.value -> x.originalUrl,w3.value -> x.source,w4.value -> x.caption,w5.value -> x.alt,w6.value -> x.scriptUrl,w7.value -> x.html,w8.value -> x.scriptName,w9.value -> x.iframeUrl,w10.value -> x.role,w11.value -> x.isMandatory)
...
} yield InteractiveElementFields(url,originalUrl,source,caption,alt,scriptUrl,html,scriptName,iframeUrl,role,isMandatory)
}