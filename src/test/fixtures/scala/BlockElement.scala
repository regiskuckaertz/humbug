...
case class BlockElement(`type`: ElementType,assets: List[Asset],textTypeData: Option[TextElementFields]= None,videoTypeData: Option[VideoElementFields]= None,tweetTypeData: Option[TweetElementFields]= None,imageTypeData: Option[ImageElementFields]= None,audioTypeData: Option[AudioElementFields]= None,pullquoteTypeData: Option[PullquoteElementFields]= None,interactiveTypeData: Option[InteractiveElementFields]= None,mapTypeData: Option[StandardElementFields]= None,documentTypeData: Option[StandardElementFields]= None,tableTypeData: Option[StandardElementFields]= None,witnessTypeData: Option[WitnessElementFields]= None,richLinkTypeData: Option[RichLinkElementFields]= None,membershipTypeData: Option[MembershipElementFields]= None,embedTypeData: Option[EmbedElementFields]= None,instagramTypeData: Option[InstagramElementFields]= None,commentTypeData: Option[CommentElementFields]= None,vineTypeData: Option[VineElementFields]= None,contentAtomTypeData: Option[ContentAtomElementFields]= None) extends TStruct
...
override val defaults = HMap[TFieldCodec](w3.value -> None,w4.value -> None,w5.value -> None,w6.value -> None,w7.value -> None,w8.value -> None,w9.value -> None,w10.value -> None,w11.value -> None,w12.value -> None,w13.value -> None,w14.value -> None,w15.value -> None,w16.value -> None,w17.value -> None,w18.value -> None,w19.value -> None,w20.value -> None)

override def encode = (x) => HMap[TFieldCodec](w1.value -> x.`type`,w2.value -> x.assets,w3.value -> x.textTypeData,w4.value -> x.videoTypeData,w5.value -> x.tweetTypeData,w6.value -> x.imageTypeData,w7.value -> x.audioTypeData,w8.value -> x.pullquoteTypeData,w9.value -> x.interactiveTypeData,w10.value -> x.mapTypeData,w11.value -> x.documentTypeData,w12.value -> x.tableTypeData,w13.value -> x.witnessTypeData,w14.value -> x.richLinkTypeData,w15.value -> x.membershipTypeData,w16.value -> x.embedTypeData,w17.value -> x.instagramTypeData,w18.value -> x.commentTypeData,w19.value -> x.vineTypeData,w20.value -> x.contentAtomTypeData)
...
} yield BlockElement(`type`,assets,textTypeData,videoTypeData,tweetTypeData,imageTypeData,audioTypeData,pullquoteTypeData,interactiveTypeData,mapTypeData,documentTypeData,tableTypeData,witnessTypeData,richLinkTypeData,membershipTypeData,embedTypeData,instagramTypeData,commentTypeData,vineTypeData,contentAtomTypeData)
}