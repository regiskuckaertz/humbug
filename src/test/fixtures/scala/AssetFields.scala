...
case class AssetFields(aspectRatio: Option[String]= None,altText: Option[String]= None,isInappropriateForAdverts: Option[Boolean]= None,caption: Option[String]= None,credit: Option[String]= None,embeddable: Option[Boolean]= None,photographer: Option[String]= None,source: Option[String]= None,stillImageUrl: Option[String]= None,width: Option[Int]= None,height: Option[Int]= None,name: Option[String]= None,secureFile: Option[String]= None,isMaster: Option[Boolean]= None,sizeInBytes: Option[Long]= None,durationMinutes: Option[Int]= None,durationSeconds: Option[Int]= None,displayCredit: Option[Boolean]= None,thumbnailUrl: Option[String]= None,role: Option[String]= None,mediaId: Option[String]= None,iframeUrl: Option[String]= None,scriptName: Option[String]= None,scriptUrl: Option[String]= None,blockAds: Option[Boolean]= None,html: Option[String]= None,embedType: Option[String]= None,explicit: Option[Boolean]= None,clean: Option[Boolean]= None,thumbnailImageUrl: Option[String]= None,linkText: Option[String]= None,linkPrefix: Option[String]= None,shortUrl: Option[String]= None,imageType: Option[String]= None,suppliersReference: Option[String]= None,mediaApiUri: Option[String]= None,copyright: Option[String]= None,mimeType: Option[String]= None,url: Option[String]= None,originalUrl: Option[String]= None,id: Option[String]= None,attribution: Option[String]= None,description: Option[String]= None,title: Option[String]= None,contentAuthSystem: Option[String]= None,alt: Option[String]= None,picdarUrn: Option[String]= None,comment: Option[String]= None,witnessEmbedType: Option[String]= None,authorName: Option[String]= None,authorUsername: Option[String]= None,authorWitnessProfileUrl: Option[String]= None,authorGuardianProfileUrl: Option[String]= None,apiUrl: Option[String]= None,dateCreated: Option[CapiDateTime]= None,youtubeUrl: Option[String]= None,youtubeSource: Option[String]= None,youtubeTitle: Option[String]= None,youtubeDescription: Option[String]= None,youtubeAuthorName: Option[String]= None,youtubeHtml: Option[String]= None,venue: Option[String]= None,location: Option[String]= None,identifier: Option[String]= None,price: Option[String]= None,start: Option[CapiDateTime]= None,end: Option[CapiDateTime]= None,safeEmbedCode: Option[Boolean]= None) extends TStruct
...
override val defaults = HMap[TFieldCodec](w1.value -> None,w2.value -> None,w3.value -> None,w4.value -> None,w5.value -> None,w6.value -> None,w7.value -> None,w8.value -> None,w9.value -> None,w10.value -> None,w11.value -> None,w12.value -> None,w13.value -> None,w14.value -> None,w15.value -> None,w16.value -> None,w17.value -> None,w18.value -> None,w19.value -> None,w20.value -> None,w21.value -> None,w22.value -> None,w23.value -> None,w24.value -> None,w25.value -> None,w26.value -> None,w27.value -> None,w28.value -> None,w29.value -> None,w30.value -> None,w31.value -> None,w32.value -> None,w33.value -> None,w34.value -> None,w35.value -> None,w36.value -> None,w37.value -> None,w38.value -> None,w39.value -> None,w40.value -> None,w41.value -> None,w42.value -> None,w43.value -> None,w44.value -> None,w45.value -> None,w46.value -> None,w47.value -> None,w48.value -> None,w49.value -> None,w50.value -> None,w51.value -> None,w52.value -> None,w53.value -> None,w54.value -> None,w55.value -> None,w56.value -> None,w57.value -> None,w58.value -> None,w59.value -> None,w60.value -> None,w61.value -> None,w62.value -> None,w63.value -> None,w64.value -> None,w65.value -> None,w66.value -> None,w67.value -> None,w68.value -> None)

override def encode = (x) => HMap[TFieldCodec](w1.value -> x.aspectRatio,w2.value -> x.altText,w3.value -> x.isInappropriateForAdverts,w4.value -> x.caption,w5.value -> x.credit,w6.value -> x.embeddable,w7.value -> x.photographer,w8.value -> x.source,w9.value -> x.stillImageUrl,w10.value -> x.width,w11.value -> x.height,w12.value -> x.name,w13.value -> x.secureFile,w14.value -> x.isMaster,w15.value -> x.sizeInBytes,w16.value -> x.durationMinutes,w17.value -> x.durationSeconds,w18.value -> x.displayCredit,w19.value -> x.thumbnailUrl,w20.value -> x.role,w21.value -> x.mediaId,w22.value -> x.iframeUrl,w23.value -> x.scriptName,w24.value -> x.scriptUrl,w25.value -> x.blockAds,w26.value -> x.html,w27.value -> x.embedType,w28.value -> x.explicit,w29.value -> x.clean,w30.value -> x.thumbnailImageUrl,w31.value -> x.linkText,w32.value -> x.linkPrefix,w33.value -> x.shortUrl,w34.value -> x.imageType,w35.value -> x.suppliersReference,w36.value -> x.mediaApiUri,w37.value -> x.copyright,w38.value -> x.mimeType,w39.value -> x.url,w40.value -> x.originalUrl,w41.value -> x.id,w42.value -> x.attribution,w43.value -> x.description,w44.value -> x.title,w45.value -> x.contentAuthSystem,w46.value -> x.alt,w47.value -> x.picdarUrn,w48.value -> x.comment,w49.value -> x.witnessEmbedType,w50.value -> x.authorName,w51.value -> x.authorUsername,w52.value -> x.authorWitnessProfileUrl,w53.value -> x.authorGuardianProfileUrl,w54.value -> x.apiUrl,w55.value -> x.dateCreated,w56.value -> x.youtubeUrl,w57.value -> x.youtubeSource,w58.value -> x.youtubeTitle,w59.value -> x.youtubeDescription,w60.value -> x.youtubeAuthorName,w61.value -> x.youtubeHtml,w62.value -> x.venue,w63.value -> x.location,w64.value -> x.identifier,w65.value -> x.price,w66.value -> x.start,w67.value -> x.end,w68.value -> x.safeEmbedCode)
...
} yield AssetFields(aspectRatio,altText,isInappropriateForAdverts,caption,credit,embeddable,photographer,source,stillImageUrl,width,height,name,secureFile,isMaster,sizeInBytes,durationMinutes,durationSeconds,displayCredit,thumbnailUrl,role,mediaId,iframeUrl,scriptName,scriptUrl,blockAds,html,embedType,explicit,clean,thumbnailImageUrl,linkText,linkPrefix,shortUrl,imageType,suppliersReference,mediaApiUri,copyright,mimeType,url,originalUrl,id,attribution,description,title,contentAuthSystem,alt,picdarUrn,comment,witnessEmbedType,authorName,authorUsername,authorWitnessProfileUrl,authorGuardianProfileUrl,apiUrl,dateCreated,youtubeUrl,youtubeSource,youtubeTitle,youtubeDescription,youtubeAuthorName,youtubeHtml,venue,location,identifier,price,start,end,safeEmbedCode)
}