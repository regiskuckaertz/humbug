...
case class TagsResponse(status: String,userTier: String,total: Int,startIndex: Int,pageSize: Int,currentPage: Int,pages: Int,results: List[Tag]) extends TStruct

object TagsResponse extends TStructCodec[TagsResponse]{
val w1 = Witness(1)
...
implicit val r8 = new TFieldCodec[w8.T,List[Tag]]()
