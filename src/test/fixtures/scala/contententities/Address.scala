...
case class Address(
  ...
  streetNumber:               Option[Short]  = None,
  streetName:                 Option[String] = None,
  neighbourhood:              Option[String] = None,
  postTown:                   Option[String] = None,
  locality:                   Option[String] = None,
  country:                    Option[String] = None,
  administrativeAreaLevelOne: Option[String] = None,
  administrativeAreaLevelTwo: Option[String] = None,
  postCode:                   Option[String] = None) extends TStruct
...
object Address extends TStructCodec[Address] {
  ...
  override def encode = (x) ⇒ HMap[TFieldCodec](
    w1.value -> x.formattedAddress,
    w2.value -> x.streetNumber,
    w3.value -> x.streetName,
    w4.value -> x.neighbourhood,
    w5.value -> x.postTown,
    w6.value -> x.locality,
    w7.value -> x.country,
    w8.value -> x.administrativeAreaLevelOne,
    w9.value -> x.administrativeAreaLevelTwo,
    w10.value -> x.postCode)
