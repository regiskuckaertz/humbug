...
case class Debug(
  lastSeenByPorterAt:   Option[CapiDateTime] = None,
  revisionSeenByPorter: Option[Long]         = None,
  contentSource:        Option[String]       = None) extends TStruct
...
object Debug extends TStructCodec[Debug] {
  ...
  override def encode = (x) ⇒ HMap[TFieldCodec](
    w1.value -> x.lastSeenByPorterAt,
    w2.value -> x.revisionSeenByPorter,
    w3.value -> x.contentSource)
