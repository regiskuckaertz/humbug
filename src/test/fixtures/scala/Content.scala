...
} yield Content(id,`type`,sectionId,sectionName,webPublicationDate,webTitle,webUrl,apiUrl,fields,tags,elements,references,isExpired,blocks,rights,crossword,atoms,stats,section,debug,isGone,isHosted)
}