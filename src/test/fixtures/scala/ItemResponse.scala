...
case class ItemResponse(status: String,userTier: String,total: Option[Int]= None,startIndex: Option[Int]= None,pageSize: Option[Int]= None,currentPage: Option[Int]= None,pages: Option[Int]= None,orderBy: Option[String]= None,content: Option[Content]= None,tag: Option[Tag]= None,edition: Option[Edition]= None,section: Option[Section]= None,results: Option[List[Content]]= None,quiz: Option[Atom]= None,relatedContent: Option[List[Content]]= None,storyPackage: Option[List[Content]]= None,editorsPicks: Option[List[Content]]= None,mostViewed: Option[List[Content]]= None,leadContent: Option[List[Content]]= None,packages: Option[List[Package]]= None,viewpoints: Option[List[Atom]]= None,media: Option[Atom]= None,explainer: Option[Atom]= None,cta: Option[Atom]= None,interactive: Option[Atom]= None,review: Option[Atom]= None,recipe: Option[Atom]= None,storyquestions: Option[Atom]= None,story: Option[Story]= None,qanda: Option[Atom]= None,guide: Option[Atom]= None,profile: Option[Atom]= None,timeline: Option[Atom]= None) extends TStruct
...
override val defaults = HMap[TFieldCodec](w3.value -> None,w4.value -> None,w5.value -> None,w6.value -> None,w7.value -> None,w8.value -> None,w9.value -> None,w10.value -> None,w11.value -> None,w12.value -> None,w13.value -> None,w14.value -> None,w15.value -> None,w16.value -> None,w17.value -> None,w18.value -> None,w19.value -> None,w20.value -> None,w21.value -> None,w22.value -> None,w23.value -> None,w24.value -> None,w25.value -> None,w26.value -> None,w27.value -> None,w28.value -> None,w29.value -> None,w30.value -> None,w31.value -> None,w32.value -> None,w33.value -> None)

override def encode = (x) => HMap[TFieldCodec](w1.value -> x.status,w2.value -> x.userTier,w3.value -> x.total,w4.value -> x.startIndex,w5.value -> x.pageSize,w6.value -> x.currentPage,w7.value -> x.pages,w8.value -> x.orderBy,w9.value -> x.content,w10.value -> x.tag,w11.value -> x.edition,w12.value -> x.section,w13.value -> x.results,w14.value -> x.quiz,w15.value -> x.relatedContent,w16.value -> x.storyPackage,w17.value -> x.editorsPicks,w18.value -> x.mostViewed,w19.value -> x.leadContent,w20.value -> x.packages,w21.value -> x.viewpoints,w22.value -> x.media,w23.value -> x.explainer,w24.value -> x.cta,w25.value -> x.interactive,w26.value -> x.review,w27.value -> x.recipe,w28.value -> x.storyquestions,w29.value -> x.story,w30.value -> x.qanda,w31.value -> x.guide,w32.value -> x.profile,w33.value -> x.timeline)
...
} yield ItemResponse(status,userTier,total,startIndex,pageSize,currentPage,pages,orderBy,content,tag,edition,section,results,quiz,relatedContent,storyPackage,editorsPicks,mostViewed,leadContent,packages,viewpoints,media,explainer,cta,interactive,review,recipe,storyquestions,story,qanda,guide,profile,timeline)
}