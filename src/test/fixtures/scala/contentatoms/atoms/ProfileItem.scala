...
case class ProfileItem(title: Option[String]= None,body: String) extends TStruct

object ProfileItem extends TStructCodec[ProfileItem]{
val w1 = Witness(1)
