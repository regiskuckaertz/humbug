...
case class PlutoData(commissionId: Option[String]= None,projectId: Option[String]= None,masterId: Option[String]= None) extends TStruct
...
override def encode = (x) => HMap[TFieldCodec](w1.value -> x.commissionId,w2.value -> x.projectId,w3.value -> x.masterId)
...
} yield PlutoData(commissionId,projectId,masterId)
}