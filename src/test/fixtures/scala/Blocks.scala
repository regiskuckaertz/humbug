...
case class Blocks(main: Option[Block]= None,body: Option[List[Block]]= None,totalBodyBlocks: Option[Int]= None,requestedBodyBlocks: Option[Map[String,List[Block]]]= None) extends TStruct
...
override def encode = (x) => HMap[TFieldCodec](w1.value -> x.main,w2.value -> x.body,w3.value -> x.totalBodyBlocks,w4.value -> x.requestedBodyBlocks)
