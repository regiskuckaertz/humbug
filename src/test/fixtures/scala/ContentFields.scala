...
case class ContentFields(
  ...
  membershipAccess:              Option[MembershipTier] = None,
  wordcount:                     Option[Int]            = None,
  commentCloseDate:              Option[CapiDateTime]   = None,
  commentable:                   Option[Boolean]        = None,
  creationDate:                  Option[CapiDateTime]   = None,
  displayHint:                   Option[String]         = None,
  firstPublicationDate:          Option[CapiDateTime]   = None,
  hasStoryPackage:               Option[Boolean]        = None,
  internalComposerCode:          Option[String]         = None,
  internalOctopusCode:           Option[String]         = None,
  internalPageCode:              Option[Int]            = None,
  internalStoryPackageCode:      Option[Int]            = None,
  isInappropriateForSponsorship: Option[Boolean]        = None,
  isPremoderated:                Option[Boolean]        = None,
  lastModified:                  Option[CapiDateTime]   = None,
  liveBloggingNow:               Option[Boolean]        = None,
  newspaperEditionDate:          Option[CapiDateTime]   = None,
  productionOffice:              Option[Office]         = None,
  publication:                   Option[String]         = None,
  scheduledPublicationDate:      Option[CapiDateTime]   = None,
  ...
  internalRevision:              Option[Int]            = None,
  internalContentCode:           Option[Int]            = None,
  ...
  shouldHideReaderRevenue:       Option[Boolean]        = None) extends TStruct
...
object ContentFields extends TStructCodec[ContentFields] {
  ...
  override def encode = (x) ⇒ HMap[TFieldCodec](
    w1.value -> x.headline,
    w2.value -> x.standfirst,
    w3.value -> x.trailText,
    w4.value -> x.byline,
    w5.value -> x.main,
    w6.value -> x.body,
    w7.value -> x.newspaperPageNumber,
    w8.value -> x.starRating,
    w9.value -> x.contributorBio,
    w10.value -> x.membershipAccess,
    w11.value -> x.wordcount,
    w12.value -> x.commentCloseDate,
    w13.value -> x.commentable,
    w14.value -> x.creationDate,
    w15.value -> x.displayHint,
    w16.value -> x.firstPublicationDate,
    w17.value -> x.hasStoryPackage,
    w18.value -> x.internalComposerCode,
    w19.value -> x.internalOctopusCode,
    w20.value -> x.internalPageCode,
    w21.value -> x.internalStoryPackageCode,
    w22.value -> x.isInappropriateForSponsorship,
    w23.value -> x.isPremoderated,
    w24.value -> x.lastModified,
    w25.value -> x.liveBloggingNow,
    w26.value -> x.newspaperEditionDate,
    w27.value -> x.productionOffice,
    w28.value -> x.publication,
    w29.value -> x.scheduledPublicationDate,
    w30.value -> x.secureThumbnail,
    w31.value -> x.shortUrl,
    w32.value -> x.shouldHideAdverts,
    w33.value -> x.showInRelatedContent,
    w34.value -> x.thumbnail,
    w35.value -> x.legallySensitive,
    w36.value -> x.allowUgc,
    w37.value -> x.sensitive,
    w38.value -> x.lang,
    w39.value -> x.internalRevision,
    w40.value -> x.internalContentCode,
    w41.value -> x.isLive,
    w42.value -> x.internalShortId,
    w43.value -> x.shortSocialShareText,
    w44.value -> x.socialShareText,
    w45.value -> x.bodyText,
    w46.value -> x.charCount,
    w47.value -> x.internalVideoCode,
    w48.value -> x.shouldHideReaderRevenue)
